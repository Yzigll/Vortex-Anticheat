--[[
    ...
    هني بعض اوبجكتات تقدر تتدخل موقع و تختار اوبجكت بلاك ليست او تشيل من بلاك ليست
    https://forge.plebmasters.de/objects
]]

return {
    "02gate3_l",
    "ac_prop_container_01a",
    "apa_heist_apart2_door",
    "apa_int_garage_wall_plug",
    "apa_mp_apa_beast_icon_mk_beast",
    "apa_mp_apa_beast_icon_mk_ring",
   ...
   "841438406",
    ...
    "des_aquaduct_root",
    "des_biotech_end",
    "des_biotech_skin_root",
    "des_biotech_start",
    "des_bridge_root",
    "des_cables_root",
    "des_cnr_window_end",
    "des_cnr_window_root1",
    "des_cnr_window_root2",
    "des_cnr_window_root3",
    "des_cnr_window_root4",
    "des_cnr_window_start",
    "des_door_end",
    "des_door_root",
    "des_door_start",
    "des_farmhs_root1",
    ...
    "des_glass_root4",
    "des_glass_start",
    "des_heli_highway001_root",
    "des_heli_highway002_root",
    "des_heli_highway003_root",
    "des_heli_highway004_root",
    "des_heli_highway005_root",
    "des_heli_highway006_skin",
    "des_heli_scrapyard_skin001",
    "des_heli_scrapyard_skin002",
    "des_heli_scrapyard_skin003",
    "des_hosp_ceil2",
    "des_hosp_ceil_end",
    "des_hosp_ceil_root",
    "des_hosp_ceil_start",
    ...
    "des_protree_root",
    "des_railing_root",
    "des_ranchsafe001_end",
    "des_ranchsafe001_root",
    "des_ranchsafe001_start",
    "des_ranchsafe002_end",
    "des_ranchsafe002_root",
    "des_ranchsafe003_skin_root",
    ...
    "mk_flag",
    "mk_ring",
    "mp_apa_yacht_new_options_mp_apa_yacht",
    "mp_apa_yacht_new_options_mp_apa_yacht_all",
    "mp_apa_yacht_new_options_mp_apa_yacht_business",
    "mp_apa_yacht_new_options_mp_apa_yacht_party",
    "mp_b_acc_artgolddisc_01",
    "mp_b_acc_artgolddisc_02",
    "mp_b_acc_artgolddisc_03",
    "mp_b_acc_artgolddisc_04",
    "mp_b_acc_artwalll_01",
    "mp_b_acc_artwallm_01",
    "mp_b_acc_bowl_01",
    "mp_b_acc_bowl_02",
    "mp_b_acc_box_trinket_01",
    "mp_b_acc_box_trinket_02",
    "mp_b_acc_candles_01",
    "mp_b_acc_flowers_01",
    "mp_b_acc_flowers_02",
    "mp_b_acc_jar_01",
    "mp_b_acc_jar_02",
    "mp_b_acc_plant_tall_01",
    "mp_b_acc_rughidel_01",
    "mp_b_acc_rugwooll_01",
    "mp_b_acc_rugwooll_02",
    "mp_b_acc_rugwooll_03",
    "mp_b_acc_sculpture_01",
    "mp_b_acc_storebox_01",
    "mp_b_acc_tray_01",
    "mp_b_acc_vase_01",
    "mp_b_acc_vase_02",
    "mp_b_acc_vase_03",
    "mp_b_bed_chestdrawer_04",
    "mp_b_bed_double_08",
    "mp_b_bed_table_dble_04",
    "mp_b_din_chair_02",
    "mp_b_din_chair_03",
    "mp_b_din_chair_04",
    "mp_b_din_chair_05",
    ...
    "mp_b_lit_floorlamp_01",
    "mp_b_lit_floorlamp_02",
    "mp_b_lit_floorlamp_03",
    "mp_b_lit_floorlamp_04",
    "mp_b_lit_floorlamp_05",
    "mp_b_lit_lamptable_02",
    "mp_b_lit_lamptable_03",
    "mp_b_lit_lamptable_04",
    "mp_b_lit_lamptable_06",
    "mp_b_lit_lightpendant_003",
    "mp_b_lit_lightpendant_01",
    "mp_b_lit_lightpendant_02",
    "mp_b_sh_bong_01",
    ...
    "mp_b_stn_sofa2seat_02",
    "mp_b_stn_sofa2seat_03",
    "mp_b_stn_sofa2seat_06",
    "mp_b_stn_sofa3seat_01",
    "mp_b_stn_sofa3seat_02",
    "mp_b_stn_sofa3seat_06",
    "mp_b_stn_sofacorn_05",
    "mp_b_stn_sofacorn_06",
    "mp_b_str_avunitl_01",
    "mp_b_str_avunitl_03",
    "mp_b_str_avunits_01",
    "mp_b_str_sideboardl_02",
    "mp_b_str_sideboardl_03",
    "mp_b_str_sideboardl_04",
    "mp_b_str_sideboards_02",
    "mp_b_tab_coffee_05",
    "mp_b_tab_coffee_06",
    "mp_b_tab_coffee_07",
    "mp_b_tab_sidelrg_01",
    ...
    "mp_b_tab_sidesml_01",
    "mp_b_tab_sidesml_02",
    "mppilotprop_fs_target_01",
    "mppilotprop_fs_target_02",
    "mppilotprop_fs_target_03",
    "mppilotprop_fs_target_base",
    ...
    "prop_abat_slide",
    "prop_ac_constructsign_01a",
    "prop_ac_dustsheet_01a",
    "prop_ac_papers_01a",
    "prop_ac_rock_01a",
    "prop_ac_rock_01b",
    "prop_ac_rock_01c",
    ...
    "prop_flag_mexico_s",
    "prop_flag_mexico_yt",
    "prop_flag_netherlands",
    "prop_flag_newzealand",
    "prop_flag_nigeria",
    "prop_flag_norway",
    "prop_flag_palestine",
    "prop_flag_poland",
    "prop_flag_portugal",
    "prop_flag_puertorico",
    "prop_flag_russia",
    "prop_flag_russia_s",
    "prop_flag_russia_yt",
    "prop_flag_s",
    ...
    "prop_flag_scotland_yt",
    "prop_flag_script",
    "prop_flag_sheriff",
    "prop_flag_sheriff_s",
    "prop_flag_slovakia",
    "prop_flag_slovenia",
    "prop_flag_southafrica",
    "prop_flag_southkorea",
    "prop_flag_spain",
    "prop_flag_sweden",
    "prop_flag_switzerland",
    "prop_flag_turkey",
    "prop_flag_uk",
    "prop_flag_uk_s",
    "prop_flag_uk_yt",
    ...
    "w_pi_appistol_mag2",
    "w_pi_appistol_sts",
    "w_pi_appistol_sts_hi",
    "w_pi_appistol_sts_mag1",
    "w_pi_appistol_sts_mag2",
    "w_pi_combatpistol",
    ...
    "w_sb_microsmg",
    "w_sb_microsmg_las",
    "w_sb_microsmg_las_hi",
    "w_sb_microsmg_las_mag1",
    "w_sb_microsmg_las_mag2",
    "w_sb_microsmg_luxe",
